<?php // Translation Hero Elementor Widget

namespace Elementor;

if ( ! defined( 'ABSPATH' ) ) exit;

class WGP_Translation_Hero extends Widget_Base
{

    public function get_name() {
        return 'wgp_translation_hero';
    }

    public function get_title() {
        return __('Translation Hero', 'wgp');
    }
    ...
    protected function render() {
        ...
        <section class="wgp-translation-hero">
            <div class="inner-wrap">
                ...
                <div class="section-img-wrap">
                    <img src="<?php bloginfo('template_url'); ?>/_inc/assets/img/translation-hero.svg" class="section-img">
                </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new WGP_Translation_Hero() );